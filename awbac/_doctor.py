...
interesting failures live BETWEEN them. "awbac is installed" is not the useful
fact -- "awbac is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awbac'
FAMILY = ['awask', 'awask', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awdit']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awbac needs at runtime, and a
